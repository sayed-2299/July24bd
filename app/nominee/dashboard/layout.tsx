...
import { LogOut, Menu, X, UserCog, FileText } from "lucide-react"

export default function NomineeDashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    {
      name: "Applications",
      href: "/nominee/dashboard/applications",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-30 bg-white border-b border-gray-200 px-4 py-2">
        <div className="flex items-center justify-between">
          <span className="font-bold text-lg text-primary">JULY 24 Nominee</span>
      ...
      >
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-center h-16 px-4 border-b border-gray-200">
            <span className="text-xl font-bold text-primary">JULY 24 Nominee</span>
          </div>
